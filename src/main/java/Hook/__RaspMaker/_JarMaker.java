...
import Hook._native.AgentMainDemo;
...
//        makeAgentJar(AgentMainDemo.class,"agentmain.jar","./src/main/java/Hook/libs",false);
        makeAgentJar(PreMainDemo.class,"premain.jar","./src/main/java/Hook/libs",true);
    }

    public static void makeAgentJar(Class compileClass, String jarName, String libPath, boolean flag) throws Throwable {
        String jarFilePath = "./src/main/java/Hook/__RaspMaker/jars/" + jarName;
